...
async function verify3000FoodAndDrinks() {
  console.log('='.repeat(70));
  console.log('🔍 VERIFYING DATABASE AFTER 3,000 FOOD & DRINKS SEEDING');
  console.log('='.repeat(70));
  ...
  console.log(`   - Total Variant Records Inspected: ${allVariants.length.toLocaleString()}`);
  ...
  // 4. Inspect Sample Egyptian & European Products
  const sampleSkus = [
    'EG-DAI-00001', // Egyptian Cheese
    'EG-JUI-00251', // Egyptian Juice
    'EG-LEG-00501', // Egyptian Legumes
    'EU-PAS-01501', // Italian Pasta
    'EU-COF-01751', // European Coffee & Chocolate
    'EU-WAT-02001', // European Mineral Water
    'EU-CON-02251', // French Mustard & Jams
    'EU-TEA-02501', // British Teas
  ];
  ...
  console.log('\n🔍 SAMPLE PRODUCT INSPECTION ACROSS EGYPT & EUROPE:');
  for (const sp of sampleProducts) {
    ...
    for (const v of sp.product_variants) {
