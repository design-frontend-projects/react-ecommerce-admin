...
const ICONS: Record<string, React.ElementType> = {
  ...
  stock_ledger: History,
  expiry_management: Clock,
  inventory_expiry: Clock,
  expiry: Clock,
  inventory_valuation: DollarSign,
  ...
  database: Database,
  lookups: Database,
  master_lookups: Database,
  areas: MapPin,
  channels: Radio,
  customer_returns: RotateCcw,
  sales_shipments: Truck,
  settings_system: Wrench,
