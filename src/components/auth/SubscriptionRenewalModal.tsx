...
export function SubscriptionRenewalModal({ open, onManageBilling }: SubscriptionRenewalModalProps) {
      ...
      <DialogContent className="sm:max-w-[500px]" onPointerDownOutside={(e) => e.preventDefault()} onEscapeKeyDown={(e) => e.preventDefault()}>
        <DialogHeader>
          <div className="flex items-center gap-2 mb-2">
            ...
            <DialogTitle className="text-2xl font-bold text-destructive">Subscription Expired</DialogTitle>
          </div>
          <DialogDescription className="text-base">
            Your Bluewave POS subscription has expired or payment failed. To restore access to your workspace, please update your billing details or renew your subscription.
          </DialogDescription>
        </DialogHeader>

        <div className="mt-4 rounded-md border p-4 bg-muted/30">
          <h4 className="text-sm font-medium mb-2">What you lose access to:</h4>
