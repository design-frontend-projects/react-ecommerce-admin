...
export const createUserApiInputSchema = z.object({
  ...
  refundPinCode: z.string().optional(),
  isRestaurantUser: z.boolean().optional(),
  primaryModule: z.enum(['inventory', 'restaurant']).optional(),
  modules: z.array(z.enum(['inventory', 'restaurant'])).optional(),
