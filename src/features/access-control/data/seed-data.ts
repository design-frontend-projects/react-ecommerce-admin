...
export const ACTIVITY_TYPE_SEEDS: ActivityTypeSeed[] = [
  { code: 'restaurant', name: 'Restaurant', description: 'Restaurant / food & beverage point of sale' },
  { code: 'inventory', name: 'Inventory', description: 'Retail / inventory management' },
]

export const MODULE_SEEDS: ModuleSeed[] = [
  { code: 'general', name: 'General', description: 'Shared, activity-agnostic surfaces', sortOrder: 0, activityTypeCodes: [] },
  { code: 'restaurant', name: 'Restaurant POS', description: 'Restaurant point-of-sale surfaces', sortOrder: 1, activityTypeCodes: ['restaurant'] },
  { code: 'inventory', name: 'Inventory', description: 'Inventory and stock management surfaces', sortOrder: 2, activityTypeCodes: ['inventory'] },
  { code: 'lookups', name: 'Lookups', description: 'Reference data', sortOrder: 3, activityTypeCodes: [] },
  { code: 'access_control', name: 'Access Control', description: 'Users, roles, permissions, screens, buttons', sortOrder: 4, activityTypeCodes: [] },
  { code: 'system', name: 'System', description: 'System-owner surfaces', sortOrder: 5, activityTypeCodes: [] },
]

export const BUTTON_SEEDS: ButtonSeed[] = [
  { code: 'create', name: 'Create', description: 'Create records on the screen' },
  { code: 'update', name: 'Update', description: 'Edit records on the screen' },
  { code: 'delete', name: 'Delete', description: 'Delete records on the screen' },
  { code: 'approve', name: 'Approve', description: 'Approve records/actions on the screen' },
  { code: 'reject', name: 'Reject', description: 'Reject records/actions on the screen' },
...
export const SCREEN_SEEDS: ScreenSeed[] = [
  // general
  { code: 'dashboard', name: 'Dashboard', route: '/', moduleCode: 'general', roles: [], permissions: ['dashboard.view'] },
  { code: 'pos', name: 'POS System', route: '/pos', moduleCode: 'general', roles: ADMINS, permissions: ['pos.access'] },
  { code: 'products', name: 'Products', route: '/products', moduleCode: 'general', roles: ADMINS, permissions: ['products.view'] },
  { code: 'subscriptions', name: 'Subscriptions', route: '/subscriptions', moduleCode: 'general', roles: ADMINS, permissions: [] },
  { code: 'customers', name: 'Customers', route: '/customers', moduleCode: 'general', roles: ADMINS, permissions: [] },
  { code: 'customer_groups', name: 'Customer Groups', route: '/customer-groups', moduleCode: 'general', roles: ADMINS, permissions: [] },
  { code: 'customer_cards', name: 'Customer Cards', route: '/customer-cards', moduleCode: 'general', roles: ADMINS, permissions: [] },
  { code: 'settings', name: 'Settings', route: '/settings', moduleCode: 'general', roles: ADMINS, permissions: ['settings.manage'] },
  ...
  // inventory
  { code: 'inventory', name: 'Inventory Items', route: '/inventory', moduleCode: 'inventory', roles: ADMINS, permissions: ['inventory.view'] },
  { code: 'inventory_shipments', name: 'Inventory Shipments', route: '/inventory/shipments', moduleCode: 'inventory', roles: ADMINS, permissions: [] },
  { code: 'stock_balances', name: 'Stock Balances', route: '/stock-balances', moduleCode: 'inventory', roles: ADMINS, permissions: ['inventory.view'] },
  { code: 'purchase_orders', name: 'Purchase Orders', route: '/purchase-orders', moduleCode: 'inventory', roles: ADMINS, permissions: [] },
  ...
  { code: 'tax_rates', name: 'Tax Rates', route: '/tax-rates', moduleCode: 'inventory', roles: ADMINS, permissions: [] },

  // lookups
  { code: 'countries', name: 'Countries', route: '/countries', moduleCode: 'lookups', roles: ADMINS, permissions: [] },
  { code: 'cities', name: 'Cities', route: '/cities', moduleCode: 'lookups', roles: ADMINS, permissions: [] },
  { code: 'currencies', name: 'Currencies', route: '/currencies', moduleCode: 'lookups', roles: ADMINS, permissions: [] },
  { code: 'branches', name: 'Branches', route: '/branches', moduleCode: 'lookups', roles: ADMINS, permissions: [] },

  // access control
  { code: 'users', name: 'User Management', route: '/users', moduleCode: 'access_control', roles: ADMINS, permissions: ['users.view'] },
  { code: 'roles', name: 'Roles', route: '/access-control/roles', moduleCode: 'access_control', roles: ADMINS, permissions: ['roles.manage'] },
  { code: 'permissions', name: 'Permissions', route: '/access-control/permissions', moduleCode: 'access_control', roles: ADMINS, permissions: ['permissions.manage'] },
  { code: 'screens', name: 'Screens Registry', route: '/access-control/screens', moduleCode: 'access_control', roles: ADMINS, permissions: ['screens.view'] },
  { code: 'buttons', name: 'Permission Buttons', route: '/access-control/buttons', moduleCode: 'access_control', roles: ADMINS, permissions: ['buttons.manage'] },

  // system (system-owner gated separately in code)
  { code: 'system_management', name: 'System Management', route: '/system', moduleCode: 'system', roles: [], permissions: [] },
  { code: 'audit_logs', name: 'Audit Logs', route: '/system/audit-logs', moduleCode: 'system', roles: [], permissions: [] },
]
