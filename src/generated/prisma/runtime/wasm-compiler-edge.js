...
var ot,
  ...
  ao = ye(() => {
    ...
    Re = (function () {
      ...
      function r(n, i, o) {
        for (var s = 0; o--; )
          ((n[o] -= s), (s = n[o] < i[o] ? 1 : 0), (n[o] = s * z + n[o] - i[o]))
...
function si(e, t, r, n) {
  switch (r.type) {
    ...
    case 'string': {
      if (typeof e != 'string')
        throw new V(`Expected a string in column '${t}', got ${typeof e}: ${e}`)
      return e
    }
    case 'int':
      switch (typeof e) {
    ...
    case 'bigint': {
      if (typeof e != 'number' && typeof e != 'string')
        throw new V(`Expected a bigint in column '${t}', got ${typeof e}: ${e}`)
...
var ur = class e {
  ...
  async interpretNode(t, r) {
    switch (t.type) {
      ...
      case 'dataMap': {
        ...
        return { value: Xs(n, t.args.structure, t.args.enums), lastInsertId: i }
      }
      case 'validate': {
        let { value: n, lastInsertId: i } = await this.interpretNode(
          t.args.expr,
  ...
  #s() {
    return this.#a?.maxBindValues !== void 0 ? this.#a.maxBindValues : this.#l()
  }
  #l() {
    if (this.#o !== void 0)
      switch (this.#o) {
      ...
      let n = async () => {
        ...
        try {
          if (t.transaction && r === 'committed')
            ...
            if (t.transaction.options.usePhantomQuery)
              await this.#s(em(), t.transaction, () => t.transaction.rollback())
            else {
              let i = Yd()
              try {
                await this.#s(i, t.transaction, () =>
...
var wn = class {
  ...
  #s(t, r) {
    ...
    if (n === 0) return t
    let i = Fi(t)
    return Nu(i, n) ? (n & X.Json && (t = JSON.stringify(t)), this.#i(t, i)) : t
  }
  #l(t, r, n) {
...
function Qi(e) {
  return function (r, n) {
    let i,
      o = (s = e) => {
        try {
          return s === void 0 || s?.kind === 'itx' ? (i ??= sl(r(s))) : sl(r(s))
        } catch (a) {
