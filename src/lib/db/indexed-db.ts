...
export interface SyncAction {
  ...
  type: 'CREATE' | 'UPDATE' | 'DELETE' | 'SYNC_POS_TRANSACTION' | 'CREATE_RES_ORDER';
...
export class OfflineDatabase extends Dexie {
  ...
  constructor() {
    ...
    this.version(2).stores({
      categories: 'id, store_id, slug, is_active, sort_order, [store_id+is_active]',
      products: 'id, store_id, category_id, slug, is_active, is_available, barcode, [store_id+is_active]',
      stores: 'id, slug',
