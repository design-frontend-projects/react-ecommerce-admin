...
- [X] T001 Create feature directory structure at `src/features/settings/`
- [X] T002 Update `prisma/schema.prisma` with `app_settings` model
...
- [X] T003 [P] Define Zod schemas and TypeScript types in `src/features/settings/data/schema.ts`
- [X] T004 Define Prisma server actions for CRUD in `src/features/settings/data/actions.ts`
- [X] T005 [P] Create TanStack Query hooks (useSettings, useUpdateSetting) in `src/features/settings/data/queries.ts`
- [X] T006 [P] Implement Zustand store for global reactive state in `src/features/settings/data/store.ts`
- [X] T007 Create `SettingsProvider` and export from `src/components/providers/settings-provider.tsx`
...
- [X] T008 [P] [US1] Create basic UI settings components (SettingField, ImageUpload) in `src/features/settings/components/`
- [X] T009 [US1] Implement `BrandingSection` block in `src/features/settings/blocks/branding-section.tsx`
- [X] T010 [US1] Assemble `SettingsPage` shell in `src/features/settings/pages/settings-page.tsx`
- [X] T011 [US1] Register `/admin/settings` route in `src/app/routes/admin/settings.tsx`
...
- [X] T012 [P] [US2] Create Localization-specific components (CurrencySelect, DateFormatPreview) in `src/features/settings/components/`
- [X] T013 [US2] Implement `RegionalSection` block in `src/features/settings/blocks/regional-section.tsx`
- [X] T014 [US2] Integrate global settings with existing currency formatting utilities in `src/lib/formatters.ts`
...
- [X] T015 [P] [US3] Create rule-specific components in `src/features/settings/components/`
- [X] T016 [US3] Implement `BusinessSection` block in `src/features/settings/blocks/business-section.tsx`
...
- [X] T017 [P] Implement global error boundary for settings module
- [X] T018 Add loading skeletons for settings forms
